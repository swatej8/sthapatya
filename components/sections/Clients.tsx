...
=======
            </div> {/* End of max-w-7xl container for top content */}
                ...
                <div className="relative w-full h-32 overflow-hidden bg-[var(--color-brand-gray)] border-y border-gray-200">
                    ...
                    <div className="absolute inset-0 flex items-center z-10 pointer-events-none">
                        <div className="flex w-max">
                            {/* Track 1 */}
                            <div className="flex animate-marquee whitespace-nowrap">
                                {Array(12).fill(councils).flat().map((council, i) => (
                                    <span key={`b1-${i}`} className="mx-12 text-xl font-bold uppercase tracking-wide text-gray-800">
                                        {council}
                                    </span>
                                ))}
                            </div>
                            ...
                            <div className="flex animate-marquee whitespace-nowrap">
                                {Array(12).fill(councils).flat().map((council, i) => (
                                    <span key={`b2-${i}`} className="mx-12 text-xl font-bold uppercase tracking-wide text-gray-800">
                                        {council}
                                    </span>
                                ))}
                            </div>
                    ...
                    >
                        <div className="flex w-max">
                            ...
                            <div className="flex animate-marquee whitespace-nowrap">
                                {Array(12).fill(councils).flat().map((council, i) => (
                                    <span key={`r1-${i}`} className="mx-12 text-xl font-bold uppercase tracking-wide text-[var(--color-brand-red)]">
                                        {council}
                                    </span>
                                ))}
                            </div>
                            ...
                            <div className="flex animate-marquee whitespace-nowrap">
                                {Array(12).fill(councils).flat().map((council, i) => (
                                    <span key={`r2-${i}`} className="mx-12 text-xl font-bold uppercase tracking-wide text-[var(--color-brand-red)]">
                                        {council}
                                    </span>
                                ))}
                            </div>
